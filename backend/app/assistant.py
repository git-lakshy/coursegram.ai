...
def _actions_prompt() -> str:
    return (
        ...
        "{topics}, mark_stage_completed {stage_position}, add_stage "
        "{stage_name, stage_topics, milestone}, remove_stage "
        "{stage_position}, set_skill_level {level}, track_course "
        ...
        "generate_assessment {stage_position}. "
